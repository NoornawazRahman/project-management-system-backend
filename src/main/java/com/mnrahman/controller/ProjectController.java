...
import com.mnrahman.entity.Project;
import com.mnrahman.entity.User;
import com.mnrahman.request.InviteRequest;
import com.mnrahman.response.MessageResponse;
import com.mnrahman.service.InvitationService;
...
public class ProjectController {
    ...
    public ResponseEntity<Invitation> acceptInviteProject(
        ...
        User user = userService.findUserProfileByJwt(jwt);
        Invitation invitation = invitationService.acceptyInvitation(token, user.getId());
